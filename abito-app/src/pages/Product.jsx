          ...
          <div className="content-box">
            <div className="content-product">
              <div className="content-product__left">
                ...
                <img src={findProduct.image} alt="product-1" className="content-product__img" />
              ...
              <div className="content-side__box">
                <div className="content-side__list">
                  <div className="content-side__list-item">
                    <img src="img/side-info-1.svg" alt="side-info" className="content-side__list-item--img" />
                  ...
                  <div className="content-side__list-item">
                    <img src="/img/side-info-2.svg" alt="side-info" className="content-side__list-item--img" />
                  ...
                  <div className="content-side__list-item">
                    <img src="/img/side-info-3.svg" alt="side-info" className="content-side__list-item--img" />
